...
SWIFT_CLASS("_TtC14JOINStoriesSDK28AnimatedCollectionViewLayout")
...
SWIFT_CLASS("_TtC14JOINStoriesSDK38AnimatedCollectionViewLayoutAttributes")
...
SWIFT_CLASS("_TtC14JOINStoriesSDK17BubbleTriggerView")
@interface BubbleTriggerView : UIView
...
SWIFT_CLASS("_TtC14JOINStoriesSDK17CachingPlayerItem")
...
SWIFT_PROTOCOL("_TtP14JOINStoriesSDK25CachingPlayerItemDelegate_")
...
SWIFT_CLASS("_TtC14JOINStoriesSDK15TriggerCardView")
@interface TriggerCardView : UIView
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end


SWIFT_CLASS("_TtC14JOINStoriesSDK15TriggerListView")
@interface TriggerListView : UIView
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end
